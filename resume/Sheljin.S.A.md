...
- **Front-End Projects & Mentorship –** Developed dynamic, responsive interfaces using HTML, CSS, JavaScript, Bootstrap, and HTMX. Implemented RESTful APIs for seamless integration with back-end services. Mentored junior developers on scalable code, industry trends, best practices, and performance optimization. 
...
**API & Documentation:** RESTful APIs, Swagger UI

**Utilities:** ReportLab, Eraser.io
